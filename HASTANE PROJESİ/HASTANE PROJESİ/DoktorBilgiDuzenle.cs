    ...
    public partial class DoktorBilgiDuzenle : Form
    {
        ...
        private void DoktorBilgiDuzenle_Load(object sender, EventArgs e)
        {
            ...
            while(dr.Read())
            {
                ...
                CmbPolikinlik.Text = dr[3].ToString();
        ...
        {
            SqlCommand komut = new SqlCommand("Update Tbl_Doktorlar set DoktorAd=@p1,DoktorSoyad=@p2,DoktorPolikinlik=@p3,DoktorSifre=@p4 where DoktorTC=@p5",bgl.baglanti());
            komut.Parameters.AddWithValue("@p1",TxtAd.Text);
            komut.Parameters.AddWithValue("@p2", TxtSoyad.Text);
            komut.Parameters.AddWithValue("@p3", CmbPolikinlik.Text);
